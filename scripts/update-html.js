...
function generateVehicleCard(vehicle, index) {
  ...
  if (vehicle.image && vehicle.image.startsWith('http')) {
    imageHtml = `                    <div class="h-48 overflow-hidden relative">
                        <img src="${vehicle.image}" alt="${vehicle.title}" class="w-full h-full object-cover" loading="lazy" onerror="this.parentElement.innerHTML='<div class=\\'vehicle-img h-48 flex items-center justify-center\\'><svg class=\\'w-16 h-16 text-slate-300\\' fill=\\'none\\' stroke=\\'currentColor\\' viewBox=\\'0 0 24 24\\'><path stroke-linecap=\\'round\\' stroke-linejoin=\\'round\\' stroke-width=\\'1\\' d=\\'M8 17a2 2 0 11-4 0 2 2 0 014 0zM20 17a2 2 0 11-4 0 2 2 0 014 0zM2 11l2-5h7l2 5M2 11h17m-17 0v5a1 1 0 001 1h1m15-6h1a2 2 0 012 2v3a1 1 0 01-1 1h-1\\'/></svg></div>'">
